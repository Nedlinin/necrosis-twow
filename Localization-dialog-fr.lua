...
function Necrosis_Localization_Dialog_Fr()
	...
	NECROSIS_MESSAGE = {
		["Error"] = {
			...
			["NoWrathstoneSpell"] = "Vous n'avez pas de sort Cr\195\169ation de Pierre de col\195\168re",
			["NoVoidstoneSpell"] = "Vous n'avez pas de sort Cr\195\169ation de Pierre du Vide",
